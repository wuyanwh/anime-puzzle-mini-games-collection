(function initEndfieldBundle() {
  ...
  class LevelManager {
    ...
    loadByIndex(index) {
      ...
      this.saveManager.setCurrentLevelId(LEVELS[safeIndex].id);
    ...
    next() {
      return this.loadByIndex((this.currentIndex + 1) % LEVELS.length);
    }

    previous() {
      return this.loadByIndex((this.currentIndex - 1 + LEVELS.length) % LEVELS.length);
    }
  }
